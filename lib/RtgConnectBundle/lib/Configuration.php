...
namespace RtgConnector\RtgConnectBundle;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (RtgConnector\RtgConnectBundle) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "http://localhost",
                "description" => "RTG-Portal dev-environment",
            ],
            [
                "url" => "https://rtg-staging.picard.de",
                "description" => "RTG-Portal staging-environment",
            ],
            [
                "url" => "https://rtg-portal.picard.de",
                "description" => "RTG-Portal production-environment",
            ]
        ];
    }
