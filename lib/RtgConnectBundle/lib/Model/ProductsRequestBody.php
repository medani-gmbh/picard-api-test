...
/**
 * ProductsRequestBody Class Doc Comment
 *
 * @category Class
 * @package  RtgConnector\RtgConnectBundle
 * @author   OpenAPI Generator team
 ...
 */
class ProductsRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductsRequestBody';
    ...
    protected static $setters = [
        ...
        'withPrices' => 'setWithPrices',
        'withAttributes' => 'setWithAttributes',
        'withLineartech' => 'setWithLineartech',
        'withImage' => 'setWithImage'
    ];
    ...
    protected static $getters = [
        ...
        'withPrices' => 'getWithPrices',
        'withAttributes' => 'getWithAttributes',
        'withLineartech' => 'getWithLineartech',
        'withImage' => 'getWithImage'
    ];
    ...
    public const WITH_PRICES_TRUE = 'true';
    public const WITH_PRICES_FALSE = 'false';
    public const WITH_ATTRIBUTES_TRUE = 'true';
    public const WITH_ATTRIBUTES_FALSE = 'false';
    public const WITH_LINEARTECH_TRUE = 'true';
    public const WITH_LINEARTECH_FALSE = 'false';
    public const WITH_IMAGE_TRUE = 'true';
    public const WITH_IMAGE_FALSE = 'false';
     ...
     * @return string[]
     */
    public function getWithPricesAllowableValues()
    {
        return [
            self::WITH_PRICES_TRUE,
            self::WITH_PRICES_FALSE,
        ];
    }
     ...
     * @return string[]
     */
    public function getWithAttributesAllowableValues()
    {
        return [
            self::WITH_ATTRIBUTES_TRUE,
            self::WITH_ATTRIBUTES_FALSE,
        ];
    }
     ...
     * @return string[]
     */
    public function getWithLineartechAllowableValues()
    {
        return [
            self::WITH_LINEARTECH_TRUE,
            self::WITH_LINEARTECH_FALSE,
        ];
    }
     ...
     * @return string[]
     */
    public function getWithImageAllowableValues()
    {
        return [
            self::WITH_IMAGE_TRUE,
            self::WITH_IMAGE_FALSE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('withPrices', $data ?? [], 'false');
        $this->setIfExists('withAttributes', $data ?? [], 'false');
        $this->setIfExists('withLineartech', $data ?? [], 'false');
        $this->setIfExists('withImage', $data ?? [], 'false');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getWithPricesAllowableValues();
        if (!is_null($this->container['withPrices']) && !in_array($this->container['withPrices'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'withPrices', must be one of '%s'",
                $this->container['withPrices'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getWithAttributesAllowableValues();
        if (!is_null($this->container['withAttributes']) && !in_array($this->container['withAttributes'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'withAttributes', must be one of '%s'",
                $this->container['withAttributes'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getWithLineartechAllowableValues();
        if (!is_null($this->container['withLineartech']) && !in_array($this->container['withLineartech'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'withLineartech', must be one of '%s'",
                $this->container['withLineartech'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getWithImageAllowableValues();
        if (!is_null($this->container['withImage']) && !in_array($this->container['withImage'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'withImage', must be one of '%s'",
                $this->container['withImage'],
                implode("', '", $allowedValues)
            );
        }
    ...
    {
        return $this->container['withPrices'];
    }

    /**
     * Sets withPrices
     *
     * @param string|null $withPrices add pricedata to datasets
     *
     * @return self
     */
    public function setWithPrices($withPrices)
    {
        if (is_null($withPrices)) {
            throw new \InvalidArgumentException('non-nullable withPrices cannot be null');
        }
        $allowedValues = $this->getWithPricesAllowableValues();
        if (!in_array($withPrices, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'withPrices', must be one of '%s'",
                    $withPrices,
        ...
        $this->container['withPrices'] = $withPrices;
    ...
    {
        return $this->container['withAttributes'];
    }

    /**
     * Sets withAttributes
     *
     * @param string|null $withAttributes add attributes to datasets
     *
     * @return self
     */
    public function setWithAttributes($withAttributes)
    {
        if (is_null($withAttributes)) {
            throw new \InvalidArgumentException('non-nullable withAttributes cannot be null');
        }
        $allowedValues = $this->getWithAttributesAllowableValues();
        if (!in_array($withAttributes, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'withAttributes', must be one of '%s'",
                    $withAttributes,
        ...
        $this->container['withAttributes'] = $withAttributes;
     ...
     * @return string|null
     */
    public function getWithLineartech()
    {
        return $this->container['withLineartech'];
    }

    /**
     * Sets withLineartech
     *
     * @param string|null $withLineartech add lineartechdata to datasets
     *
     * @return self
     */
    public function setWithLineartech($withLineartech)
    {
        if (is_null($withLineartech)) {
            throw new \InvalidArgumentException('non-nullable withLineartech cannot be null');
        }
        $allowedValues = $this->getWithLineartechAllowableValues();
        if (!in_array($withLineartech, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'withLineartech', must be one of '%s'",
                    $withLineartech,
        ...
        $this->container['withLineartech'] = $withLineartech;
    ...
    {
        return $this->container['withImage'];
    }

    /**
     * Sets withImage
     *
     * @param string|null $withImage add imagenames to datasets
     *
     * @return self
     */
    public function setWithImage($withImage)
    {
        if (is_null($withImage)) {
            throw new \InvalidArgumentException('non-nullable withImage cannot be null');
        }
        $allowedValues = $this->getWithImageAllowableValues();
        if (!in_array($withImage, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'withImage', must be one of '%s'",
                    $withImage,
        ...
        $this->container['withImage'] = $withImage;
